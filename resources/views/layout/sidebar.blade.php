    ...
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          ...
          <div class="nav-profile-text d-flex flex-column">
            ...
            <span class="text-secondary text-small">{{$user->hasRole->user_role}}</span>
          </div>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="order-manage-collapse">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{route('showOrderHistory')}}">Lịch sử Order</a></li>
          </ul>
        </div>
      </li>
      {{-- Quản lý đặt bàn --}}
      <li class="nav-item">
        ...
        <div class="collapse" id="reservation-manage-collapse">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('showReservationList')}}">Danh sách yêu cầu đặt bàn</a></li>
          </ul>
        </div>
      </li>
