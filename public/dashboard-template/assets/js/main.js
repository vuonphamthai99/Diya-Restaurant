const assetsLink = $('meta[name="assets-link"').attr("content");
const defaultImage = assetsLink + "dashboard-template/assets/images/blank.jpg";
const defaultLink = assetsLink + "images/menu/";
...
$(document).ready(function () {
        ...
        initComplete: function () {
            ...
            api.columns()
                ...
                .each(function (colIdx) {
                    ...
                    var title = $(cell).text();
                    $(cell).html(
                        `<input type="text" style="width: 100% !important;" class="form-control" placeholder="${$.trim(
                            title
                        )}" aria-label="${$.trim(
                            title
    ...
    $(".my-table").on("click", function () {
        $("#order-btn")
            .removeClass("btn-gradient-secondary")
        ...
        if ($(this).attr("idTable") == idTable) {
            $("#order-btn")
                ...
                .removeClass("btn-gradient-primary");
            $("#checkout-btn")
                .addClass("btn-gradient-secondary")
                .removeClass("btn-gradient-primary");
            $(this).attr("style", "");
            ...
            success: function (data) {
                ...
                $.each(data, function (i, val) {
                    ...
                    let html = `<tr>
                                ...
                                <td > ${val.quantity}</td>
                                <td>${formatCurrency(
                                    val.menuPrice.toString()
                                )}</td>
                                <td><button type="button" idDetail="${
                                    val.id
                                }" class="delete-detail btn btn-fw btn-danger">Xóa món</button></td>
                            </tr>`;
